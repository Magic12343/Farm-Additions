...
public class SpecialGrassBlock extends Block implements IGrowable {
	...
	public SpecialGrassBlock(Properties properties, Supplier<BlockState> diesTo, Function<Random, BlockState> vegitationGetter) {
		super(properties);
		this.diesTo = diesTo;
